...
The Markdown editor widget is a [WireCloud widget](http://wirecloud.readthedocs.org/en/latest/) that provides the
ability to edit markdown formatted text using WireCloud.
